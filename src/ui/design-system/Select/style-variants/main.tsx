...
export const singleSelect = tv({
  slots: {
    ...
    dropdown:
      "bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden dark:border-gray-700 dark:bg-gray-900",
    searchContainer: "p-3 border-b border-gray-100 dark:border-gray-800",
    searchInput:
      "w-full px-3 py-2 text-sm border border-gray-200 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100 dark:placeholder:text-gray-500",
    optionsList: "max-h-48 overflow-y-auto",
    option:
      "flex items-center px-3 py-2.5 cursor-pointer transition-colors select-none hover:bg-gray-50 dark:hover:bg-gray-800",
    optionContent: "flex-1",
    optionText: "text-sm dark:text-gray-100",
...
export const multiSelect = tv({
  slots: {
    ...
    optionsList: "max-h-48 overflow-y-auto",
    option:
      "flex items-center px-3 py-2.5 cursor-pointer transition-colors hover:bg-gray-50 dark:hover:bg-gray-800",
    checkbox:
    ...
    optionText: "text-sm select-none text-gray-700 dark:text-gray-100",
    footer:
      "px-3 py-2 border-t border-gray-100 text-xs bg-gray-50 text-gray-600 dark:border-gray-800 dark:bg-gray-950 dark:text-gray-400",
    tag: "inline-flex items-center gap-1.5 px-2.5 py-1 text-sm rounded-md transition-all duration-200 bg-blue-100 text-blue-800 hover:bg-blue-200 dark:bg-blue-950 dark:text-blue-200 dark:hover:bg-blue-900",
