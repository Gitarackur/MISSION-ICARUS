...
export const dataOutputStyles = tv({
  slots: {
    container: 'space-y-5 dark:text-gray-100',
    emptyState:
      'flex flex-col items-center justify-center border border-gray-200 bg-white p-10 text-center dark:border-gray-800 dark:bg-gray-900',
    ...
    button: 'mt-4 bg-blue-600 px-4 py-2 text-sm font-medium text-white rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition-colors duration-150',
    ...
    columnsContainer:
      'flex flex-wrap gap-3 max-w-full max-h-40 overflow-y-auto border border-gray-200 rounded-sm p-2 bg-gray-50 dark:border-gray-800 dark:bg-gray-950',
    columnsItem: 'flex items-center space-x-2 cursor-pointer select-none',
    tableWrapper: 'overflow-x-auto w-full rounded-sm border border-gray-200 dark:border-gray-700',
    ...
    paginationButton:
      'px-3 py-1 rounded-sm border border-gray-300 transition-colors duration-150 dark:border-gray-700',
    ...
    paginationInfo: 'px-3 py-1 border border-gray-300 rounded-sm bg-gray-50 text-gray-700 select-none dark:border-gray-700 dark:bg-gray-950 dark:text-gray-200',
    ...
    clearAnalysisSelection: "px-3 py-1 bg-gray-500 text-white text-sm rounded-sm hover:bg-gray-600 transition-colors",
    checkboxStyles: "rounded-sm border-gray-300 text-blue-600 focus:ring-blue-500",
...
export const importDataStyles = tv({
  slots: {
    ...
    label: 'block text-sm font-medium text-gray-700 mb-2 dark:text-gray-200',
    uploadBox: 'border-2 border-dashed border-gray-300 rounded-sm p-6 text-center dark:border-gray-700',
    ...
    hiddenInput: 'hidden',
    button: 'bg-blue-600 px-4 py-2 rounded-sm text-white transition-colors duration-200 ease-in-out',
